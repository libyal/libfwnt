...
{
	static char *function = "libfwnt_notify_set_stream";
...
int libfwnt_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libfwnt_notify_stream_open";
...
int libfwnt_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libfwnt_notify_stream_close";
