...
TEST_FUNCTIONS="access_control_entry access_control_list security_descriptor security_identifier support";
...
test_python_function_with_input()
{
	...
	run_test_on_input_directory "pyfwnt" "${TEST_DESCRIPTION}" "default" "${OPTION_SETS}" "${TEST_SCRIPT}" "input" "${INPUT_GLOB}";
	local RESULT=$?;
