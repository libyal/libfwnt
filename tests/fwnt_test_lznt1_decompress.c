...
#define FWNT_TEST_LZNT1_DECOMPRESS_VERBOSE
 */
...
#endif
{
...
#if defined( HAVE_DEBUG_OUTPUT ) && defined( FWNT_TEST_LZNT1_DECOMPRESS_VERBOSE )
	     ...
	     &error ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to decompress LZNT1 compressed data." );
