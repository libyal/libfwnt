/*
 * Library LZXPRESS Huffman decompression testing program
 *
...
#define FWNT_TEST_LZXPRESS_HUFFMAN_DECOMPRESS_VERBOSE
 */
...
#endif
{
...
#if defined( HAVE_DEBUG_OUTPUT ) && defined( FWNT_TEST_LZXPRESS_HUFFMAN_DECOMPRESS_VERBOSE )
	     ...
	     &error ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to decompress LZXPRESS Huffman compressed data." );
