...
$LibraryTests = "access_control_entry access_control_list bit_stream error huffman_tree lznt1 lzx lzxpress security_descriptor security_identifier support"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\fwnt_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libfwnt"
